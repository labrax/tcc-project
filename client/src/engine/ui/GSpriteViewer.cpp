...
void GSpriteViewer::draw(sf::RenderWindow * window)
{
    ...
    sf::Sprite * sp = DataLoader::getInstance().getSprite("assets/roguelikeChar_transparent.png", 1, 6);
    sf::Sprite * bkpg = DataLoader::getInstance().getSprite("assets/roguelikeCity_transparent.png", 0, 19);
